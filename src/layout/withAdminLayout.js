            ...
            >
              <Row>
                <Col lg={!topMenu ? 4 : 3} sm={6} xs={12} className="align-center-v navbar-brand">
                  ...
                  >
                    <img
                      src={!darkMode ? require(`../static/img/logo.png`) : require(`../static/img/logo.png`)}
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <Footer className="admin-footer" style={footerStyle}>
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">HCMUTE © 2022 All Rights Reserved</span>
                      </Col>
                      <Col md={12} xs={24}>
                        <div className="admin-footer__links">
                          <NavLink to="#">Giới thiệu</NavLink>
                          <NavLink to="#">Liên hệ người quản trị</NavLink>
                        </div>
                      </Col>
                    </Row>
                  </Footer>
