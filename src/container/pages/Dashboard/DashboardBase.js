          ...
          <Col xs={24}>
            <DashboardBaseStyleWrap>
              <Cards headless title="Theme Colors" size="large">
                <Row gutter={15}>
                  <Col lg={2}>
                    <Palette colorCode={theme["primary-color"]}>
                      Primary
                    </Palette>
                  </Col>
                  <Col lg={2}>
                  ...
                  <Col lg={2}>
                    <Palette colorCode={theme["success-color"]}>
                      Success
                    </Palette>
                  </Col>
                  <Col lg={2}>
                  ...
                  <Col lg={2}>
                    <Palette colorCode={theme["warning-color"]}>
                      Warning
                    </Palette>
                  </Col>
                  <Col lg={2}>
          ...
          <Col xs={24}>
            <DashboardBaseStyleWrap>
              <Cards headless title="Hover Colors" size="large">
                <Row gutter={15}>
                  <Col lg={2}>
                    <Palette colorCode={theme["primary-hover"]}>
                      Primary
                    </Palette>
                  </Col>
                  <Col lg={2}>
                  ...
                  <Col lg={2}>
                    <Palette colorCode={theme["success-hover"]}>
                      Success
                    </Palette>
                  </Col>
                  <Col lg={2}>
                  ...
                  <Col lg={2}>
                    <Palette colorCode={theme["warning-hover"]}>
                      Warning
                    </Palette>
                  </Col>
                  <Col lg={2}>
