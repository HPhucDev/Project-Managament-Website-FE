            ...
            <SupportContentWrap>
                  ...
                  <Row align="middle">
                    <Col lg={16} sm={14} xs={24}>
                      <div className="sDash_support-content">
                        <h2 className="sDash_support-content__title">
                          Chào bạn, chúng tôi có thể giúp được gì cho bạn ?
                        </h2>
                        <p>Những tài liệu bên dưới có thể có hữu ích với bạn</p>
                      </div>
                    </Col>
                    ...
                    <Col lg={8} sm={10} xs={24}>
                      <div className="sDash_support-img">
                        <img
                          src={require(`../../../static/img/help.png`)}
                          alt=""
                        />
                      </div>
                    </Col>
              ...
              <div className="sDash-support-container">
                  ...
                  <Row gutter={30}>
                    <Col lg={8} xs={24}>
                      <div className="sDash-support-link-item">
                        ...
                        <h4 className="sDash-support-link-item__title">
                          Knowledgebase
                        </h4>
                        <div className="sDash-support-link-item__content">
                          <p>Lorem ipsum dolor sit amet consetetur</p>
                          <Link
                            to="./knowledgebase/plugins"
                            className="btn-link"
                          >
                            Learn More
                          </Link>
                    ...
                    <Col lg={8} xs={24}>
                      <div className="sDash-support-link-item">
                        <div className="sDash-support-link-item__icon info">
                          <img
                            src={require(`../../../static/img/icon/chat.svg`)}
                            alt=""
                          />
                        </div>
                    ...
                    <Col lg={8} xs={24}>
                      <div className="sDash-support-link-item">
                        <div className="sDash-support-link-item__icon success">
                          <img
                            src={require(`../../../static/img/icon/documentation.svg`)}
                            alt=""
                          />
                        </div>
                        <h4 className="sDash-support-link-item__title">
                ...
                <div className="sDash_faq-block">
                  <Cards headless title="Những câu hỏi thường gặp">
                    <FaqWrapper>
                      <Collapse
                        bordered={false}
                        defaultActiveKey={["0"]}
                      ...
                      >
                        ...
                        >
                          <p>
                            Many support queries and technical questions will
                            already be answered in supporting documentation such
                            as FAQ&rsquo;s and comments from previous buyers.
