...
const NotificationSorting = Styled.div`
    margin-bottom: 25px;
    .notification-sort-bar{
        ...
        align-items: center;
        margin: 0 -10px;
        .notification-sort-nav,
        .notification-sort-search,
        .notification-sort-group{
            padding: 0 10px;
        }
    ...
    @media (max-width: 1500px){
        ...
        .notification-sort-group .sort-group{
            .ant-select{
                min-width: 180px;
            }
        }
    ...
    @media (min-width: 1201px) and (max-width: 1300px) {
        ...
        .notification-sort-group .sort-group .layout-style a{
            width: 35px;
            height: 35px;
        }
        .notification-sort-group .sort-group .ant-select {
            min-width: 170px;
            ${({ theme }) =>
...
const NotificationPagination = Styled.div`
    .ant-pagination{
        display: flex;
        justify-content: flex-end;
...
const NotificationListAssignees = Styled.div`
    ul{
        margin: -3px;
        padding: 0;
        display: flex;
